...
query = "i want to buy a car under 25 lakh"

print("="*80)
print("TEST CASE: CUSTOM CAR SEARCH UNDER 25 LAKH")
print("="*80)
...
assert any("Explore" in t or "car" in t.lower() for t in task_titles), "Task titles are not dynamic!"
...
assert "STRATEGIC FEASIBILITY REPORT: I WANT TO BUY A CAR UNDER 25 LAKH" in report_content, "Report is not dynamic!"
assert "car" in report_content.lower(), "Report doesn't discuss the car!"
assert "NCAP" in report_content, "NCAP safety rating table is not present!"
assert "25 Lakh" in report_content, "Budget limit is missing!"

print("\n" + "="*80)
print("QA TEST SUCCESS: Custom Car Search under 25 Lakh generated successfully and verified!")
print("="*80)
